    ...
    <div className="space-y-10">
      <section className="grid gap-10 lg:grid-cols-12 lg:items-center">
        <div className="lg:col-span-7">
          ...
          <p className="mt-4 max-w-2xl text-pretty text-base leading-relaxed text-neutral-300">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link
              to="/projects"
              className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-3 text-sm font-semibold text-neutral-950 transition hover:bg-neutral-200"
            >
              View projects
            </Link>
            <Link
              to="/showcase"
              className="inline-flex items-center justify-center rounded-xl border border-[#e8c840]/50 bg-[#e8c840]/15 px-5 py-3 text-sm font-semibold text-[#f5e6a3] transition hover:border-[#e8c840]/80 hover:bg-[#e8c840]/25"
            >
              Design showcase
            </Link>
            <Link
        ...
        <div className="lg:col-span-5">
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-fuchsia-500/10 via-cyan-400/10 to-amber-300/10 p-6">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.14),transparent_55%)]" />
            <div className="relative">
              <div className="text-xs font-semibold tracking-[0.25em] text-neutral-300">
                SELECTED WORK
              </div>
              <div className="mt-4 grid grid-cols-2 gap-3">
                {featured.map((p) => (
                  <Link
                    key={p.id}
                    to={`/projects/${p.id}`}
                    className="group overflow-hidden rounded-xl border border-white/10 bg-neutral-950/30"
                  >
